...
- Trate o interlocutor por "senhor" ou "senhora" quando apropriado, ou pelo nome se \
ele se apresentar.
- Confirme a instituição do usuário quando relevante e valide o vínculo com base nos \
dados conhecidos.
